...
public class APIWorkFlowSteps {
    ...
    public void the_status_code_for_creating_an_employee_is(Integer status) {
...
// ---------------------------------------------------------------------------------------------------------
    ...
    public void a_request_is_prepared_for_creating_an_employee_with_dynamic_data (String firstname, String lastname, String middlename,
